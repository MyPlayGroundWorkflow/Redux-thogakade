...
const Dashboard = () => {
  ...
  const stats = [
    { title: 'Total Customers', value: totalCustomers, icon: Users, color: 'bg-blue-500' },
    { title: 'Total Items', value: totalItems, icon: Package, color: 'bg-green-500' },
    { title: 'Total Orders', value: totalOrders, icon: ShoppingCart, color: 'bg-purple-500' },
    { title: 'Revenue', value: '$12,543', icon: DollarSign, color: 'bg-red-500' },
  ];
